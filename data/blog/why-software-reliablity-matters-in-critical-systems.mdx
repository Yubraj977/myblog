...
draft: false
summary: 'Examining the $2.08 trillion impact of poor software quality on critical systems and exploring AI-driven solutions like Intuitionistic Fuzzy Similarity Measures that achieve 93% accuracy in bug detection to enhance reliability in healthcare, finance, and military systems.'
description: 'Learn how software failures cost $2.08 trillion annually and discover AI-driven solutions for improving reliability in critical systems. Explore real-world cases like Mars Climate Orbiter and Therac-25, plus modern approaches using CNN and RNN for automated bug detection.'
images: ['/static/images/canada/toronto.jpg']
authors: ['yubraj']
layout: PostLayout
canonicalUrl: 'https://blog.yubrajkhatri.com.np/blog/why-software-reliablity-matters-in-critical-systems'
---

![Software reliability in critical systems - computer code and circuit board representing secure system architecture for healthcare, finance, and military applications](https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)
...
### 1. Krasner, Herb. _The Cost of Poor Software Quality in the US: A 2020 Report_. Consortium for Information & Software Quality, 2021.

- Estimates **$2.08 trillion** in software-related losses, emphasizing the importance of **quality assurance practices**.

### 2. Nagwani, Naresh Kumar, and Jasjit S. Suri. _An Artificial Intelligence Framework on Software Bug Triaging, Technological Evolution, and Future Challenges_. International Journal of Information Management Data Insights, vol. 3, 2023.

- Reviews **AI-based bug triaging techniques**, including **CNNs and RNNs**.

### 3. Panda, Rama Ranjan, and Naresh Kumar Nagwani. _Software Bug Severity and Priority Prediction Using SMOTE and Intuitionistic Fuzzy Similarity Measure_. Applied Soft Computing Journal, vol. 150, 2024.

- Discusses **Intuitionistic Fuzzy Similarity Measures (IFSM)**, which improve bug prioritization **accuracy to 93%**.

### 4. Vowler, Julia. _How Lethal Is the Millennium Bug?_ Computer Weekly, 6 Nov. 1997.
